...
module.exports.initPlayer= function () {
  angular.bootstrap(angular.element('#path-container'), ['PathEditorApp']);
};

module.exports.initEditor= function () {
  angular.bootstrap(angular.element('#path-container'), ['PathPlayerApp']);
};
